    ...
    >
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <TabIconPill focused={focused}>
              <Home size={18} color={color} strokeWidth={focused ? 2 : 1.6} />
            </TabIconPill>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <TabIconPill focused={focused}>
              <ClipboardList size={18} color={color} strokeWidth={focused ? 2 : 1.6} />
            </TabIconPill>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <TabIconPill focused={focused}>
              <MessageCircle size={18} color={color} strokeWidth={focused ? 2 : 1.6} />
            </TabIconPill>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <TabIconPill focused={focused}>
              <View>
                <ShoppingCart size={18} color={color} strokeWidth={focused ? 2 : 1.6} />
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <TabIconPill focused={focused}>
              <User size={18} color={color} strokeWidth={focused ? 2 : 1.6} />
            </TabIconPill>
          ),
        }}
      />
