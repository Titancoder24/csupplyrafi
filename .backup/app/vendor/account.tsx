      ...
      >
        ...
        <Section title="Help">
          <LinkRow
            Icon={HelpCircle}
            label="Support"
            sub="Get help with orders, payouts, KYC"
            onPress={() => router.push('/vendor/notifications' as never)}
          />
          <LinkRow
            Icon={FileText}
  ...
  return (
    <View style={[info.row, !last && info.rowDivider]}>
      <View style={info.iconWrap}>
        <Icon size={14} color={INK_500} strokeWidth={2} />
      </View>
      <View style={{ flex: 1 }}>
  ...
  return (
    ...
    >
      <View style={[info.iconWrap, { backgroundColor: ORANGE_BG }]}>
        <Icon size={15} color={ORANGE_DK} strokeWidth={2} />
      </View>
      <View style={{ flex: 1 }}>
