        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, focused }) => (
              <Home size={20} color={color} strokeWidth={focused ? 2.4 : 1.75} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            title: 'Trips',
            tabBarIcon: ({ color, focused }) => (
              <ClipboardList size={20} color={color} strokeWidth={focused ? 2.4 : 1.75} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            title: 'Earnings',
            tabBarIcon: ({ color, focused }) => (
              <IndianRupee size={20} color={color} strokeWidth={focused ? 2.4 : 1.75} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            title: 'Account',
            tabBarIcon: ({ color, focused }) => (
              <User size={20} color={color} strokeWidth={focused ? 2.4 : 1.75} />
            ),
          }}
        />
