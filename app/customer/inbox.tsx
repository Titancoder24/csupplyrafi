...
export default function InboxScreen() {
  ...
  const load = useCallback(async (silent = false) => {
    ...
    try {
      ...
      if (!orders || orders.length === 0) { setThreads([]); return; }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: SURFACE }} edges={['top']}>
      ...
      <View style={s.header}>
        <View style={s.headerIcon}>
          <InboxIcon size={20} color="#0F172A" strokeWidth={2} />
        </View>
        <View style={{ flex: 1 }}>
      ...
      {loading ? (
        ...
        <View style={s.emptyBox}>
          <View style={s.emptyIcon}>
            <MessageCircle size={36} color="#0F172A" strokeWidth={1.5} />
          </View>
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                ...
                <ChevronRight size={18} color="#0F172A" strokeWidth={2} />
              </Pressable>
            );
          }}
        />
