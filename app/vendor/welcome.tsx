/**
 * /vendor/welcome — C-Supply vendor onboarding gate.
...
import { ArrowRight, ArrowLeft, Store, Wallet, TrendingUp } from 'lucide-react-native';
            ...
            <View style={s.cardInner}>
              ...
              <View style={s.eyebrowWrap}>
                <View style={s.eyebrow}>
                  ...
                  <Text style={s.eyebrowTxt}>JOIN AS VENDOR</Text>
                </View>
              </View>

              <Text style={s.heading}>
                Grow your business{'\n'}
                <Text style={s.headingAccent}>with verified buyers.</Text>
              </Text>

              <Text style={s.subhead}>
                Reach contractors, builders and businesses across India. List your
                catalog, accept orders and get settled in 2 days.
              </Text>

              <View style={s.statsCard}>
                <View style={s.statCell}>
                  <View style={s.statIcon}>
                    <TrendingUp size={18} color="#0F172A" strokeWidth={1.75} />
                  </View>
                  <Text style={s.statValue}>₹50L+</Text>
                  <Text style={s.statLabel}>Avg monthly GMV</Text>
                </View>
                ...
                <View style={s.statCell}>
                  ...
                  <Text style={s.statValue}>2 days</Text>
                  <Text style={s.statLabel}>Settlement cycle</Text>
                </View>
                <View style={s.statDivider} />
                <View style={s.statCell}>
                  <View style={s.statIcon}>
                    <Store size={18} color="#0F172A" strokeWidth={1.75} />
                  </View>
                  <Text style={s.statValue}>0%</Text>
                  <Text style={s.statLabel}>Listing fee</Text>
                </View>
              </View>
              ...
              <View style={s.ctaRow}>
                ...
                <Pressable
                  ...
                  onPress={() => router.push('/vendor/onboarding/1' as never)}
                >
...
const s = StyleSheet.create({
  ...
  eyebrowDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: ACCENT },
  eyebrowTxt: {
  ...
  signinBtnTxt: { fontFamily: FontFamily.semiBold, fontSize: 14, color: INK },
  registerBtn: {
    flex: 1,
