      ...
      <View style={s.kpiFoot}>
        {trend ? (
          <View style={s.kpiTrendRow}>
            {trend.positive
              ? <TrendingUp   size={11} color={C.green} strokeWidth={2.2} />
              : <TrendingDown size={11} color={C.red}   strokeWidth={2.2} />}
          ...
          <View style={s.headerRight}>
            ...
            <Pressable style={s.refreshBtn} onPress={fetchAll} disabled={loading}>
              {loading
                ...
                : <RefreshCw size={13} color={C.textSub} strokeWidth={2} />}
              ...
              return (
                <View key={u.id} style={[s.tRow, i === recentUsers.length - 1 && { borderBottomWidth: 0 }]}>
                  ...
                  <Pressable style={{ width: 30, alignItems: 'center' }} hitSlop={4}>
                    <MoreVertical size={14} color={C.textHint} strokeWidth={2} />
                  </Pressable>
                </View>
              );
            })
...
const s = StyleSheet.create({
  ...
  headerLeft: { flex: 1, gap: 4, minWidth: 240 },
  pageTitle: { fontFamily: FontFamily.bold, fontSize: 22, color: C.text, letterSpacing: -0.4, lineHeight: 26 },
  pageSub:   { fontFamily: FontFamily.regular, fontSize: 13, color: C.textMuted, lineHeight: 18 },
  ...
  kpiLabel: { fontFamily: FontFamily.medium, fontSize: 12, color: C.textMuted },
  kpiValue: {
    fontFamily: FontFamily.bold, fontSize: 26, color: C.text,
    letterSpacing: -0.6, lineHeight: 30,
  },
  kpiFoot: { minHeight: 14 },
  kpiTrendRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  kpiTrendTxt: { fontFamily: FontFamily.semiBold, fontSize: 11 },
  kpiSub:      { fontFamily: FontFamily.regular,  fontSize: 11, color: C.textHint, marginLeft: 2 },
