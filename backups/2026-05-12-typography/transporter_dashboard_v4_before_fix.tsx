    ...
    <View style={{ gap: 12, marginBottom: 8 }}>
      ...
      <View style={s.homeCard}>
        <View style={s.homeCardHead}>
          ...
          <Pressable onPress={onViewAll} style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
            ...
            <ChevronRight size={13} color="#1A5C30" strokeWidth={2.2} />
          </Pressable>
        </View>
      ...
      {activeTrip ? (
          ...
          <View style={s.activeTripBody}>
            <View style={{ flex: 1, gap: 10 }}>
              ...
              <View style={s.tripEtaRow}>
                <Clock size={12} color="#64748B" strokeWidth={1.75} />
            ...
            {activeTrip.pickup?.lat && activeTrip.drop?.lat ? (
              ...
              <View style={[s.miniMap, { alignItems: 'center', justifyContent: 'center', backgroundColor: '#F1F5F9' }]}>
                <MapPin size={18} color="#94A3B8" strokeWidth={1.75} />
        ...
        <View style={[s.homeCard, { alignItems: 'center', paddingVertical: 18 }]}>
          <Truck size={20} color="#94A3B8" strokeWidth={1.75} />
...
export default function TransporterDashboard() {
  ...
  return (
    <View style={s.root}>
      ...
      >
        {/* ── Home Stack — summary at the top of every tab ── */}
        <HomeStack
          activeJobs={activeJobs}
          todayStats={todayStats}
          monthly={monthly}
          onViewAll={() => setActiveTab('current')}
        />
            ...
            {online && (
              <View style={s.section}>
                ...
                {loadingDeliveries ? (
                  ...
                  <EmptyTruckState
                    title="No new delivery jobs"
                    sub="You're online — we'll show jobs here as soon as vendors broadcast them"
                  />
                ) : (
                  pendingJobs.map(job => {
            ...
            {!online && (
              <View>
                <EmptyTruckState
                  ...
                  sub="Toggle online to start receiving available delivery jobs"
                  online={false}
                />
