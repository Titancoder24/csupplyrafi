...
/** Type scale aligned with Linear / Stripe — line-heights bundled. */
export const Type = {
  // Heads
  pageTitle:    { fontFamily: 'Inter_700Bold',     fontSize: 22, lineHeight: 28, letterSpacing: -0.3 },
  sectionTitle: { fontFamily: 'Inter_600SemiBold', fontSize: 15, lineHeight: 20, letterSpacing: -0.1 },
  cardTitle:    { fontFamily: 'Inter_600SemiBold', fontSize: 14, lineHeight: 18 },
  // Body
  body:         { fontFamily: 'Inter_400Regular',  fontSize: 13.5, lineHeight: 20 },
  bodyStrong:   { fontFamily: 'Inter_500Medium',   fontSize: 13.5, lineHeight: 20 },
  // Small / meta
  caption:      { fontFamily: 'Inter_400Regular',  fontSize: 12, lineHeight: 16, color: '#64748B' },
  label:        { fontFamily: 'Inter_500Medium',   fontSize: 12, lineHeight: 16, letterSpacing: 0.1 },
  // Numbers / metrics
  metric:       { fontFamily: 'Inter_700Bold',     fontSize: 26, lineHeight: 30, letterSpacing: -0.6 },
  metricSmall:  { fontFamily: 'Inter_600SemiBold', fontSize: 18, lineHeight: 22, letterSpacing: -0.2 },
  // Buttons
  button:       { fontFamily: 'Inter_600SemiBold', fontSize: 14, lineHeight: 18, letterSpacing: 0.1 },
  // Pills
