/**
 * /transporter/welcome — C-Supply transporter onboarding gate.
...
import { ArrowRight, ArrowLeft, Truck, Zap, Clock } from 'lucide-react-native';
            ...
            <View style={s.cardInner}>
              ...
              <View style={s.eyebrowWrap}>
                <View style={s.eyebrow}>
                  ...
                  <Text style={s.eyebrowTxt}>JOIN AS TRANSPORTER</Text>
                </View>
              </View>

              <Text style={s.heading}>
                Deliver more,{'\n'}
                <Text style={s.headingAccent}>earn more.</Text>
              </Text>

              <Text style={s.subhead}>
                Pick up materials, deliver to customers, get paid. C-Supply gives you a
                steady flow of pre-priced trips across India.
              </Text>
              ...
              <View style={s.statsCard}>
                <View style={s.statCell}>
                  ...
                  <Text style={s.statLabel}>Per delivery</Text>
                </View>
                <View style={s.statDivider} />
                <View style={s.statCell}>
                  <View style={s.statIcon}>
                    <Zap size={18} color="#0F172A" strokeWidth={1.75} />
                  </View>
                  <Text style={s.statValue}>Instant</Text>
                  <Text style={s.statLabel}>Payouts</Text>
                </View>
                <View style={s.statDivider} />
                <View style={s.statCell}>
                  <View style={s.statIcon}>
                    <Clock size={18} color="#0F172A" strokeWidth={1.75} />
                  </View>
                  <Text style={s.statValue}>24/7</Text>
                  <Text style={s.statLabel}>Jobs available</Text>
                </View>
              </View>
              ...
              <View style={s.ctaRow}>
                ...
                <Pressable
                  ...
                  onPress={() => router.push('/transporter/onboarding/1' as never)}
                >
