...
import {
  ...
  Bell, AlertTriangle, CheckCircle2, Clock, HelpCircle,
  ...
  return (
    <View style={s.root}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        {/* Support */}
        <Text style={[s.sectionTitle, { marginTop: 8 }]}>Help</Text>
        <View style={s.card}>
          <Row
            icon={HelpCircle}
            label="Support & Help"
            value="Raise a ticket"
            onPress={() => router.push('/transporter/support' as never)}
            chevron
          />
        </View>
        ...
        <View style={{ marginTop: 12 }}>
          <Pressable style={s.signOutBtn} onPress={handleSignOut}>
            <LogOut size={15} color="#0F172A" strokeWidth={2} />
...
function Row({
  ...
  return (
    <Wrap style={s.row} onPress={onPress}>
      ...
      {chevron ? <ChevronRight size={13} color="#0F172A" strokeWidth={2} /> : null}
    </Wrap>
  );
}
