      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
            ...
            {([
              ...
              >
                <View style={[s.modeIconBox, { backgroundColor: mode === key ? color + '20' : BG }]}>
                  <Icon size={20} color={mode === key ? color : MUTED} strokeWidth={1.8} />
                </View>
        ...
        {mode === 'schedule' && (
          <View style={s.card}>
            ...
            <Pressable style={s.dateRow}>
              <Calendar size={16} color={PRIMARY} strokeWidth={1.8} />
            ...
            <View style={s.slotsCol}>
              {SLOTS.map(sl => {
                ...
                return (
                  ...
                  >
                    <Clock size={15} color={active ? SURFACE : MUTED} strokeWidth={2} />
        ...
        {mode === 'instant' && (
          <View style={s.instantCard}>
            <Zap size={18} color="#B45309" strokeWidth={1.8} />
