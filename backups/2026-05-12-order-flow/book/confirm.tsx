          ...
          <React.Fragment key={step.key}>
            <View style={t.step}>
              <View style={[t.circle, done && t.circleDone]}>
                {done
                  ? <CheckCircle2 size={13} color={SURFACE} strokeWidth={2.5} />
                  : <View style={t.dot} />
                }
              </View>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.successRing}>
          <View style={s.successInner}>
            <CheckCircle2 size={52} color={GREEN} strokeWidth={1.6} />
          </View>
        </View>
        ...
        <View style={s.actions}>
          ...
          >
            <MapPin size={16} color={SURFACE} strokeWidth={2} />
          ...
          >
            <Home size={16} color={TEXTSUB} strokeWidth={2} />
